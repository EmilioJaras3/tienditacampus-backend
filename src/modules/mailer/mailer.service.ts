...
/**
 * MailerService Unificado
 * Integra la lógica robusta de 2FA con fallback a consola.
 */
@Injectable()
export class MailerService {
    ...
    async sendMail(to: string, subject: string, html: string): Promise<boolean> {
        if (!this.transporter) {
            this.logger.warn(`Simulación de envío (No SMTP): A: ${to}, Asunto: ${subject}`);
            return true;
        }
    ...
    /**
     * Envía el código 2FA con diseño premium.
     */
